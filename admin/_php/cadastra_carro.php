...
if(empty($_POST["carro_nome"]) || empty($_POST["carro_preco"]) || empty($_POST["carro_modelo"])){  ?>

    <script>alert("Preencha os campos para continuar");</script>
<?php 
    header("refresh: 0.1; url= ../adiciona_carro.php");
    die();
	...
	$carro_preco = $_POST["carro_preco"]; 
  $carro_modelo = $_POST["carro_modelo"];
	$carro_descricao = $_POST["carro_descricao"];
	require_once("valida_upload.php");
...
$texto = str_replace( ' ',  '', $carro_nome );

//Converte pra minisculo
$nome_minusculo = strtolower($texto);
 
// diretório onde encontra-se o arquivo
$filename = "../../".$nome_minusculo.".php";




	$sql = "INSERT INTO carro SET carro_data = '$dateNew', carro_nome = '$carro_nome', carro_preco = '$carro_preco', carro_modelo = '$carro_modelo', carro_imagem_mini = '$nome_final', carro_url = '$nome_minusculo',  carro_descricao = '$carro_descricao'  "; 
