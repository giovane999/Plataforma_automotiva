                      ...
                      <?php foreach($resultado as $carros) : ?>
                            ...
                            <div class="title-bar clearfix">
                              ...
                              <div class="container">
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    <h3><strong><?= $carros['carro_modelo'] ?></strong><?= $carros['carro_nome'] ?></h3>
                                    <!-- start title imgb -->
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="row clearfix">
                                    <div class="col-md-8">
                                      ...
                                      <div class="version-car" style="margin-bottom: 13px;"><?= $carros['carro_nome'] ?></div>
                                        ...
                                        <div class="clearfix">
                                          ...
                                          <div class="tab-content clearfix" style="display: none;">
                                            <div class="wrap-img-car img">
                                              <img class="img-responsive tira id  active " src="assets/img_mini/<?= $carros['carro_imagem_mini'] ?>" alt="">
                                            </div>
                                          </div>
                                          <!-- end tab content -->
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <div class="fillform inte fillform2 clearfix">
                                        ...
                                        <form action="#" class="formComponent">
                                          ...
                                          <input name="modelo" type="text" readonly="readonly" value="<?= $carros['carro_nome'] ?>" class="form-control form-control1 input-car">
                                          <select
                            ...
                            <p class="descricao_carro"> Preço: <?= $carros['carro_preco'] ?></p> <br>
                            <p class="descricao_carro"> Modelo: <?= $carros['carro_modelo'] ?></p> <br>
                            <p><?= $carros['carro_descricao'] ?></p>
                          <!-- end row -->
                          </div>
                          <!-- end container -->
                          </div>
